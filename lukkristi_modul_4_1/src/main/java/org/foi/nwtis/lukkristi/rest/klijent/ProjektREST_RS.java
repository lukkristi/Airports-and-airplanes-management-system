 ...
 * USAGE:
 * <pre>
 *        ProjektREST_RS client = new ProjektREST_RS();
...
public class ProjektREST_RS {
    ...
    public ProjektREST_RS() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("aerodromiProjekt");
    }
     public ProjektREST_RS(String korisnik, String lozinka){
        client = javax.ws.rs.client.ClientBuilder.newClient();
    ...
    public Response obrisiMojAerodom(Object requestEntity, String icao) throws ClientErrorException {
        return webTarget.path(java.text.MessageFormat.format("{0}", new Object[]{icao})).request(javax.ws.rs.core.MediaType.APPLICATION_JSON).delete(Response.class);
    }
    ...
    public Response obrisiAvioneAerodoma(Object requestEntity, String icao) throws ClientErrorException {
        return webTarget.path(java.text.MessageFormat.format("{0}/avioni", new Object[]{icao})).request(javax.ws.rs.core.MediaType.APPLICATION_JSON).delete(Response.class);
    }
