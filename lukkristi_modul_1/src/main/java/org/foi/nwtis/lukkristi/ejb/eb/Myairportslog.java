...
public class Myairportslog implements Serializable {
    ...
    public Integer getNumberofairplanes() {
        return numberofairplanes;
    }

    public void setNumberofairplanes(Integer numberofairplanes) {
    ...
    public String toString() {
        return "org.foi.nwtis.lukkristi.ejb.eb.Myairportslog[ myairportslogPK=" + myairportslogPK + " ]";
    }
